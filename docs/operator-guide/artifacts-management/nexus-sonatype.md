...
Without [Add-ons approach](https://github.com/epam/edp-cluster-add-ons/blob/main/clusters/core) you need to manually create blob stores, repository, roles, **Service Account** `ci.user`:
