...
[KubeRocketCI Terraform AWS Platform](https://github.com/KubeRocketCI/terraform-aws-platform). This setup seamlessly integrates OIDC with minimal effort.
    ...
    "Statement": [
        {
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::<AWS_ACCOUNT_A_ID>:role/ArgoCD-IRSA-Role"
            },
            "Action": "sts:AssumeRole"
        },
        {
            ...
            "Condition": {
                ...
                "StringEquals": {
                    "oidc.eks.<AWS_REGION>.amazonaws.com/id/EXAMPLED539D4633E53DE1B71EXAMPL:aud": "sts.amazonaws.com"
                }
            }
        }
    ]
    ...
    "Statement": [
        {
            "Effect": "Allow",
            "Action": "sts:AssumeRole",
            "Resource": "arn:aws:iam::<AWS_ACCOUNT_B_ID>:role/ArgoCD-Stage-Access"
        }
    ]
}
```
