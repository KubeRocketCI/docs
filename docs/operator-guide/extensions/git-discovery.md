...
2. Configure the KrakenD API Gateway to expose GitFusion endpoints by modifying its routing configuration.
    ...
    2. Access the KrakenD configuration directory at `clusters/<cluster-name>/addons/krakend` and modify the `values.yaml` file to include the GitFusion API endpoints:
    ...
    3. Configure the KrakenD secret to include GitFusion service connectivity details.
        ...
        {
          "SONARQUBE_URL": "http://sonar.<krci-namespace>:9000",
