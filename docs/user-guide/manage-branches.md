...
2. Fill in the required fields to create a new branch:
  ...
  :::
    ...
    :::note
    The **Branch name** field remains static if you create a release branch. If you want to onboard an existing branch using the **Clone** or **Import** strategy, enter its name in this field.
    :::
