      ...
      items: [
          ...
          items: [
            ...
            'operator-guide/auth/namespace-management',
            {
              ...
              items: [
                ...
                'operator-guide/microsoft-entra/opensearch-authentication',
        ...
        },
        {
          ...
          items: [
            ...
            'operator-guide/upgrade/migrate-custom-tekton-pipelines-3.15',
          ],
        },
        {
          type: 'category',
          ...
          items: [
            ...
            'operator-guide/troubleshooting/environment-creation',
