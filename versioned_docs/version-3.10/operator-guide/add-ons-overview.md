...
3. Clone a private copy of add-ons repository to your local machine and install preconfigured **Argo CD** Helm chart from `/argo-cd` folder using the command below:
