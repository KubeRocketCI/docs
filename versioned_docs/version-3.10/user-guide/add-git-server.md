...
3. Enable integration in KubeRocketCI:
    ...
    Navigate to **Configuration** section and select **Version Control System** tab from the left sidebar menu. Click the **Add Gitserver** button and fill in the following fields in the opened form:
