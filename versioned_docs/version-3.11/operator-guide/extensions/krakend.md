...
1. Define the KrakenD API gateway URL:
    ...
    :::note
    This URL should point to the ingress URL of the KrakenD API Gateway. By default, this [value](https://github.com/epam/edp-install/blob/v3.11.0/deploy-templates/values.yaml#L16) is left empty, which means that the widgets are disabled by default.
    :::
