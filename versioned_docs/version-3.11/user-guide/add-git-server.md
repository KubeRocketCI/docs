...
3. Enable integration in KubeRocketCI:
    ...
    Navigate to the **Configuration** section and select the **Version Control System** tab in the left sidebar. Click the **Add Gitserver** button and fill in the following fields in the opened dialog:
