...
This section provides detailed instructions for upgrading the EPAM Delivery Platform to version 3.9.0. Follow the steps and requirements outlined below:

:::warning
  EDP-Install version v.3.9 is not support Kiosk as tenancy engine. Please migrate to Capsule engine or disable this options.
:::
...
3. To upgrade EDP to the v3.9.0, run the following command:
